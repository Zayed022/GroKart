...
export default function TermsAndConditions() {
    return (
      <div className="min-h-screen bg-white px-4 py-10 sm:px-10 md:px-20">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">Terms & Conditions</h1>
          <p className="text-sm text-gray-500 mb-8">Last updated on 29-04-2025 22:42:10</p>
  
          <div className="space-y-6 text-gray-700 leading-relaxed text-justify">
            <p>
              These Terms and Conditions, along with our privacy policy and other applicable terms (“Terms”), constitute a binding agreement between <strong>MOHD ZAYED MOHD SALIM ANSARI</strong> (“Website Owner”, “we”, “us”, or “our”) and you (“you” or “your”), regarding your use of our website, products, or services (collectively, “Services”).
            </p>
