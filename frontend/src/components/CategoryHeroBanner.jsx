...
>
      ...
      <div className="flex-1 text-left">
        ...
        <Link to={ctaLink}>
          <button className="mt-4 px-4 py-2 bg-white text-gray-800 font-medium rounded-lg shadow hover:bg-gray-100 transition duration-200">
            {ctaText}
          </button>
        </Link>
      </div>
  ...
  <img
    src={image}
    alt={title}
    className="h-[220px] w-[220px] md:h-[240px] md:w-[240px] rounded-xl object-contain"
    loading="lazy"
  />
</div>
